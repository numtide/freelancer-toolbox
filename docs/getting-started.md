...
See [Country Guides](./countries/) for specific requirements in your location.
...
Choose software compatible with your local tax laws (VAT, income tax reports). See your [country guide](./countries/) for recommendations specific to your location.
...
Next: [Country Guides](./countries/) | [Workflows](./workflows/)
