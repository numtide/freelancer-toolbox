...
class TransactionOperations:
    ...
    def link_transaction(
        ...
        """Link a transaction to another object (Voucher or Invoice).

        Args:
            transaction_id: ID of the transaction
            target_id: ID of the object to link to
            target_type: Type of object ("Voucher" or "Invoice")
    ...
    def link_transaction_to_voucher(
        self,
        transaction_id: int,
        voucher_id: int,
    ) -> dict[str, Any]:
        ...
        Args:
            transaction_id: ID of the transaction
            voucher_id: ID of the voucher to link to

        Returns:
            Response data

        """
        return self.link_transaction(transaction_id, voucher_id, "Voucher")
    ...
    def link_transaction_to_invoice(
        ...
        Args:
            transaction_id: ID of the transaction
            invoice_id: ID of the invoice to link to

        Returns:
            Response data

        """
        return self.link_transaction(transaction_id, invoice_id, "Invoice")

    def unlink_transaction(self, transaction_id: int) -> dict[str, Any]:
